...
atlas_id: cacheline
description: Cache line bouncing happens when different CPU core tries to access variables/memory locations which are held by same cache line. This force the hardware to enforce cache coherency, consuming extra cycles.
---
